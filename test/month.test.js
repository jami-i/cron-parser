...
describe('month parser', function() {
  
  describe("parsing", () => {
    it('can parse "*" pattern', function() {
      const type = typeof Month.tryParse("*");
      assert.ok(type === 'function');
    });
  
    it('can parse static number pattern', function() {
      const type = typeof Month.tryParse("12");
      assert.ok(type === 'function');
    });

    it('can parse static number pattern', function() {
      const type = typeof Month.parse("14").value;
      assert.ok(type !== 'function');
    });

    it('can parse static number pattern', function() {
      const type = typeof Month.parse("0").value;
      assert.ok(type !== 'function');
    });
  
    it('can parse static or static pattern', function() {
      const type = typeof Month.tryParse("1,12");
      assert.ok(type === 'function');
    });
  
    it('can parse range pattern', function() {
      const type = typeof Month.tryParse("1-3");
      assert.ok(type === 'function');
    });

    it('can parse range or range pattern', function() {
      const type = typeof Month.tryParse("1-3,9-12");
      assert.ok(type === 'function');
    });

    it('can parse static or range pattern', function() {
      const type = typeof Month.tryParse("1,3-5");
      assert.ok(type === 'function');
    });

    it('can parse range or static pattern', function() {
      const type = typeof Month.tryParse("1-5,10");
      assert.ok(type === 'function');
    });
  });
  ...
  describe('validator', function() {
    describe('static number', () => {
      it('static number match', function() {
        const validator = Month.tryParse("1");
        assert.ok(validator(1) === true);
      });
  
      it('static number mismatch -1', function() {
        const validator = Month.tryParse("2");
    ...
    describe("range operator", () => {
      it('range mismatch left -1', function() {
        const validator = Month.tryParse("2-9");
        assert.ok(validator(1) === false);
      });
    ...
    describe("or operator" ,() => {
      it('or mismatch 1', function() {
        const validator = Month.tryParse("1,11");
    ...
    describe("complex pattern", () => {
      it("ok", () => {
        const validator = Month.tryParse("2-3,5,7,9-11");
